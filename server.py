...
# الإصدار: 3.5.2 - مع عرض خطوات الحل بشكل جميل ومتكامل (مصحح)  
# ============================================================================    
...
async def solve_with_steps(data: ExpressionRequest):    
    ...
    try:    
        ...
        # ===== تحديد نوع المسألة والحصول على التفاصيل الكاملة =====
        result_data = None
        template_id = 0
        ...
        # تنسيق الخطوات
        formatted = format_solution_steps(template_id, result_data, expr)
...
if __name__ == "__main__":    
    ...
    print("=" * 70)    
    print("🧮 تشغيل خادم الويب المتكامل - النسخة النهائية v3.5.2")    
    print("=" * 70)    
