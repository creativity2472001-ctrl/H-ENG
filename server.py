            ...
            if system:
                if system["type"] == "system_2x2":
                    ...
                    if result and 'solution' in result:
                        sol = result['solution']
                        return {"success": True, "result": f"x = {sol['sympy']['x']}, y = {sol['sympy']['y']}"}
                    ...
                    if result and 'solutions' in result and result['solutions']:
                        sol = result['solutions']['sympy_method']
                        return {"success": True, "result": f"x = {sol['x']}, y = {sol['y']}, z = {sol['z']}"}
