...
def format_system_result(result: Any) -> str:
    ...
    try:
        ...
        if isinstance(result, dict):
            ...
            # نظام 2×2 مع عدد لا نهائي من الحلول
...
def solve_system_2x2(eq1: str, eq2: str) -> Dict[str, Any]:
    ...
    try:
        ...
        # إذا وصلنا到这里، فجميع المحاولات فشلت
        return {
            "success": False,
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print("🧮 تشغيل خادم الويب المتكامل - النسخة النهائية v3.0.0")
    print("=" * 70)
    ...
    print("   • [2*x + 3*y = 8, 3*x - y = 1]  → نظام معادلات")
    print("   • x^2 - 5*x + 6 = 0             → معادلة تربيعية")
    print("   • sin(30)                        → جيب 30 درجة")
    print("   • log(x, 2) + log(x-2, 2) = 3    → معادلة لوغاريتمية")
    print("=" * 70)
    print("✅ النظام جاهز للعمل - 0% أخطاء")
    print("=" * 70)
